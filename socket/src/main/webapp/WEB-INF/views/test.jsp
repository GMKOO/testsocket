...
socket.onmessage = function(event) {
    ...
    //messageContent.textContent = ;    
 	messageContent.textContent = event.data; //대화내용
 	
    const messageTime = document.createElement("span");
    messageTime.className = "msg_time";
    messageTime.textContent = "8:40 Today";
...
%>
    ...
    <footer><button type="button" onclick="location.href='./login'">로그인</button>
    <button type="button" onclick="location.href='./'">홈으로</button></footer>
